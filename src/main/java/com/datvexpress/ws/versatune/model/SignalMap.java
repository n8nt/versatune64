...
/*
        This component creates a hash map with all possible messages that the CombitunerExpress application
        can send through the PIPE. Versatune maps each possible message to an event in the TunerStatus enumeration.
        Some events contain parameters such as frequency or bandwidth so only the first part of those messages
        can be used as a key in the hashmap.
...
public class SignalMap {
   final HashMap<String, Integer> hMap;
    ...
    public int findTunerStatusFromResponseKey(String key){
