package com.datvexpress.ws.versatune.gpio;
...
public class SimpleGpioInput extends Component {
         ...
         */
        public SimpleGpioInput(Context pi4j, PIN address, boolean inverted) {
         ...
         */
        public SimpleGpioInput(Context pi4j, PIN address, boolean inverted, long debounce) {
